...
using TestDLL.ServiceReference1;

namespace TestDLL
{
    public partial class wcf客户端 : Form
    {
        #region Housekeeping
        ...
        {
            TestDLL.Properties.Settings.Default.Save();
        }
            ...
            try
            {
                ...
                using (System.IO.FileStream stream = new System.IO.FileStream(FileTextBox.Text, System.IO.FileMode.Open, System.IO.FileAccess.Read))
                {
                    using (StreamWithProgress uploadStreamWithProgress = new StreamWithProgress(stream))
                    {
                        ...
                        TestDLL.ServiceReference1.FileTransferServiceClient client = new TestDLL.ServiceReference1.FileTransferServiceClient();
